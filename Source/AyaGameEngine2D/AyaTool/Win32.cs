...
namespace AyaGameEngine2D
{
	...
	public static class Win32
	{
        ...
        /// 获取CPU晶振增长频率
        /// </summary>
        /// <param name="PerformanceFrequency">每秒晶振次数</param>
        /// <returns>获取成功标记</returns>
        [DllImport("kernel32")]
        ...
        /// 获得CPU晶振次数
        /// </summary>
        /// <param name="PerformanceCount">晶振总次数</param>
        /// <returns>获取成功标记</returns>
        [DllImport("kernel32")]
        [SuppressUnmanagedCodeSecurity]
        ...
        /// 检查消息队列，将消息存入指定结构
        /// </summary>
        /// <param name="msg">消息结构</param>
        /// <param name="hWnd">窗口句柄</param>
        /// <param name="messageFilterMin">第一个消息</param>
        /// <param name="messageFilterMax">最后一个消息</param>
        /// <param name="flags">处理方式</param>
        /// <returns></returns>
        [System.Security.SuppressUnmanagedCodeSecurity]
        ...
        /// <returns>结果句柄</returns>
        [DllImport("user32.dll")]
        public static extern IntPtr GetWindowRect(IntPtr hwnd, ref Rectangle lpRect);
        
        /// <summary>
        /// 获取设备
        /// </summary>
        /// <param name="hWnd">设备句柄</param>
        /// <returns>结果句柄</returns>
        [DllImport(User32)]
        ...
        /// <param name="uFlags">窗口位置枚举</param>
        /// <returns>结果</returns>
        [DllImport(User32)]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        /// 注册类
        /// </summary>
        /// <param name="lpwcx">指向一个WNDCLASSEX结构的指针</param>
        /// <returns>窗口类型的标识号，失败为0</returns>
        [DllImport(User32)]
        ...
        /// Midi输出消息
        /// </summary>
        /// <param name="hMidiOut">Midi句柄</param>
        /// <param name="dwMsg">消息内容</param>
        /// <returns>句柄</returns>
        [DllImport("winmm.dll")]
        public static extern UInt32 midiOutShortMsg(UInt32 hMidiOut, UInt32 dwMsg);

        /// <summary>
        /// Midi输出打开
        /// </summary>
        /// <param name="lphMidiOut">Midi句柄</param>
        /// <param name="uDeviceID">设备ID</param>
        /// <param name="dwCallback">回调句柄</param>
        /// <param name="dwInstance">实例句柄</param>
        /// <param name="dwFlags">flag</param>
        /// <returns>句柄</returns>
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("winmm.dll")]
        public static extern UInt32 midiOutOpen(out UInt32 lphMidiOut, uint uDeviceID, UInt32 dwCallback, UInt32 dwInstance, UInt32 dwFlags);
        ...
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("winmm.dll")]
        public static extern UInt32 midiOutReset(UInt32 hMidiOut);
        ...
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("winmm.dll")]
        public static extern UInt32 midiOutClose(UInt32 hMidiOut);

        /// <summary>
        /// 获取精确计时结构TimerCaps
        /// </summary>
        /// <param name="caps">精确计时结构</param>
        /// <param name="sizeOfTimerCaps">计时结构尺寸</param>
        /// <returns>结果</returns>
        [System.Security.SuppressUnmanagedCodeSecurity]
        ...
        /// <param name="resolution">定时器使用的分辨率（精确度）</param>
        /// <param name="proc">若触发方式为回调函数，则为回调函数的指针；若采用事件方式，则为 event object 的handle</param>
        /// <param name="user">可为任意变量或者结构地址，他会在定时器触发的时候回传给回调函数</param>
        /// <param name="mode">定时器类型，共有两组旗标</param>
        /// <returns>事件id</returns>
        [System.Security.SuppressUnmanagedCodeSecurity]
        [DllImport("winmm.dll", CharSet = CharSet.Auto, SetLastError = true)]
        public static extern int timeSetEvent(int delay, int resolution, Object proc, Object user, int mode);
        #endregion
